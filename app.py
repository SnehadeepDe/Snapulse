...
def predict():
    if request.method == "POST":
        ...
        values = np.array([[age,sex_0,sex_1,cp_0,cp_1,cp_2,cp_3,bp,chol,fbs_0,ecg_0,ecg_1,ecg_2,mhr,exang_0,exang_1,oldpeak,slp_0,slp_1,slp_2,caa_0,caa_1,caa_2,thall_1,thall_2,thall_3]])
